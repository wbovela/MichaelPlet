...
Private Sub Make_BMP()
    ...
    Open App.Path & "\All chars.txt" For Output As #1
    ...
    Picture1.Width = 80 * MapWidth + 4: Picture1.Height = 64 * MapHeight + 4
        ...
        For MapX = 0 To MapWidth - 1
            ...
            For BlockY = 0 To 7
                For BlockX = 0 To 9
                    ...
                    Print #1, Right$("00" & Hex(CharVal), 2)
                    ...
                    For Ix1 = 0 To 7
                        ...
                        'If Memory(56000) And 8 Then
                            For Ix2 = 6 To 0 Step -2
                                ...
                                X = 80 * MapX + 8 * BlockX + 6 - Ix2
                                Y = 64 * MapY + 8 * BlockY + Ix1
