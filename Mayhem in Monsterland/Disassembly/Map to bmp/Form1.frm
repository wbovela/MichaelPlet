...
Begin VB.Form Form1 
   ...
   Begin VB.TextBox txtFilename 
      ...
      Left            =   480
      TabIndex        =   0
      Text            =   "D:\Michael\C64\Games\Mayhem in Monsterland\Disassembly\MAYHEM05.PRG"
      Top             =   600
      Width           =   7335
   End
...
Private Sub Make_BMP(BlockNo As Long)
    ...
    Dim ColTab As Long
    Dim DiffCont As Long

    If BlockNo < 0 Then
        Blocks = 32777
    Else
        Blocks = 32777 + 16 * BlockNo
    End If

    CharSet = 30720: ColTab = 35072
    MapStart = 35328
    MapWidth = 256: MapHeight = 6 '20
    ...
    For MapY = 0 To MapHeight - 1 '19
        ...
        For MapX = 0 To MapWidth - 1
            ...
            If BlockIx > 191 Then DiffCont = DiffCont + 32: GoTo Cont
                    ...
                    For Ix1 = 0 To 7
                        ...
                        'If Memory(56000) And 8 Then
                            For Ix2 = 6 To 0 Step -2
                                ...
                                X = 32 * MapX + 8 * BlockX + 6 - Ix2 - DiffCont
                        ...
                        Else
                            For Ix2 = 7 To 0 Step -1
                                ...
                                X = 32 * MapX + 8 * BlockX + 7 - Ix2 - DiffCont
                                Y = 32 * MapY + 8 * BlockY + Ix1
...
Cont:
    ...
    Else
        SavePicture Picture1.Image, App.Path & "\Blocks\" & Right$("000" & BlockNo, 3) & ".bmp"
    End If
End Sub
