...
Begin VB.Form Form1 
   ...
   Begin VB.TextBox txtFilename 
      ...
      Left            =   4080
      TabIndex        =   0
      Text            =   "D:\Michael\C64\Games\Shadow of the Beast\Disassembly\Map to BMP\SHADOWCRT B5.PRG"
      Top             =   720
      Width           =   4095
   End
...
Private Sub Make_BMP()
    ...
    CharSet = 51200
    MapStart = 30592
    MapWidth = 119: MapHeight = 70

    Picture1.Width = 16 * MapWidth + 2: Picture1.Height = 16 * MapHeight + 2

    For MapY = 0 To MapHeight - 1
        For MapX = 0 To MapWidth - 1
            'BlockIx = Memory(MapStart + MapWidth * MapY + MapX)
            BlockIx = Memory(MapStart + (MapY \ 10) * 10 * MapWidth + MapY + 10 * MapX)

            For BlockY = 0 To 1
                For BlockX = 0 To 1
                    'CharVal = Memory(Blocks + 4 * BlockIx + 2 * BlockY + BlockX)
                    CharVal = Memory(Blocks + BlockIx + 512 * BlockY + 256 * BlockX)
                    ...
                    For Ix1 = 0 To 7
                        If Memory(56000) And 8 Then
                            For Ix2 = 6 To 0 Step -2
                                ...
                                X = 16 * MapX + 8 * BlockX + 6 - Ix2
                                Y = 16 * MapY + 8 * BlockY + Ix1
                                ...
                                Case 3
                                    Picture1.PSet (X, Y), Colors(Memory(56000) And 7)
                                    Picture1.PSet (X + 1, Y), Colors(Memory(56000) And 7)
