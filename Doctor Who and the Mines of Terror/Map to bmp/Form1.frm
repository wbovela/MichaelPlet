...
Begin VB.Form Form1 
   ...
   Begin VB.TextBox txtFilename 
      ...
      Left            =   4080
      TabIndex        =   0
      Text            =   "D:\Michael\C64\Games\Doctor Who and the Mines of Terror\Disassembly\Map to bmp\DRWHOB5.PRG"
      Top             =   720
      Width           =   4095
   End
...
Private Sub Make_BMP()
    ...
    Blocks = 12288
    CharSet = 16384: ColTab = 12032
    MapStart = 57344
    MapWidth = 128: MapHeight = 56 '20
    ...
    For MapY = 0 To MapHeight - 1 '19
        For MapX = 0 To MapWidth - 1
            ...
            For BlockY = 0 To 3
                For BlockX = 0 To 3
                    CharVal = Memory(Blocks + 16 * BlockIx + 4 * (3 - BlockY) + BlockX)
